...
function Card({user,handleRemove,id}) {
  return (
    ...
    <p className=' mt-2 text-center text-xs font-semibold leading-1 tracking-tight'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet, quidem! Aperiam, sint.</p>
